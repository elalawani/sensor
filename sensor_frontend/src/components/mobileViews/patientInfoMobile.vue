        ...
        >
            <swiper-slide>
                <div class="rounded-xl">
                    <div class="p-4">
                        <div class="flex items-center text-center flex-col px-2 py-5">
                            ...
                            <button
                                    class="py-3 px-8 rounded-xl my-3
                                    dark:text-slate-100 text-sky-700 dark:bg-sky-900 dark:hover:bg-sky-700 dark:border-0
                                    border border-sky-700 hover:bg-sky-700 hover:text-slate-100"> Send Email </button>
                            swipe to see more >>
...
export default {
  ...
  // Assuming you're fetching the customer data when this component is created
  created() {
    // fetch the customer data here and assign it to this.customer
  }
}
</script>
