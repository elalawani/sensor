<template>
        ...
        <form class="flex flex-col w-full" @submit.prevent="submitForm">
            ...
            <div class="mb-5">
                add Visit documentation for patient
            ...
            <div class="flex flex-row w-full justify-around items-center">
                ...
                <div class="w-full flex-col flex">
                    <label for="visit_reason" class="block mb-2 text-sm font-medium">visit reason</label>
                    <textarea
                        type="text"
                ...
                <div class="w-full flex-col flex">
                    <label for="misc_documentation" class="block mb-2 text-sm font-medium">misc documentation</label>
                    <textarea
                        type="text"
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post('/api/documentation/visit/create/', this.form)
                .then(response => {
