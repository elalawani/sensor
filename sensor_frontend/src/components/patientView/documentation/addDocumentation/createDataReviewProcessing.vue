<template>
        ...
        <form class="flex flex-col w-full" @submit.prevent="submitForm">
            ...
            <div class="flex flex-row items-center mb-8">
                ...
                <div class="ml-10 flex flex-col w-full">
                    <label for="blood_cholesterol" class="block mb-2 text-sm font-medium ">Dauer in Month</label>
                    <div class="flex flex-row items-center mr-12">
                        <input
                            type="number"
                            v-model="form.duration"
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post('/api/documentation/data_review_processing/create/', this.form)
                .then(response => {
