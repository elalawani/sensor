<template>
        ...
        <form class="flex flex-col w-full" @submit.prevent="submitForm">
            ...
            <div class="mb-5">
                add initial interview telephones for patient
            ...
            <div class="flex flex-row items-center mb-8">
                ...
                <div class="ml-10 flex flex-col w-full">
                    <label for="status" class="block mb-2 text-sm font-medium">conversation reason</label>
                    <input
                        type="text"
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post('/api/documentation/initial_interview_telephones/create/', this.form)
                .then(response => {
