        ...
        <div
            ...
            <table
                ...
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.patient.last_name}},  {{feedbackCareTeamTelephoneConsultation.patient.first_name}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.created_by.name}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.code}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.created_at}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.feedback_necessary}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.feedback_questions}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.feedback_to}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.recommendations}}
                    </td>
                </tr>
               <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
                    ...
                    <td class="pl-2 py-4">
                        {{feedbackCareTeamTelephoneConsultation.visit_reason}}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    <th class="pl-2 py-4 dark:bg-sky-700 w-fit">
