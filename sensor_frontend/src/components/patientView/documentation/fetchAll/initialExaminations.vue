        ...
        <div
            ...
            <table class="rounded text-sm text-left text-slate-500 dark:text-slate-100 w-full">
                ...
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    ...
                    <td class="pl-2 py-4">
                        {{ examination.patient.last_name }}, {{ examination.patient.first_name }}
                    </td>
                </tr>
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                ...
                <tr class="border dark:bg-slate-800 dark:border-slate-700">
                    ...
                    <td class="pl-2 py-4">
                        {{ examination.patient.doctors }}
                        {{ examination.patient.nurses }}
                    </td>
                </tr>
                </tbody>
            </table>
...
const fetchData = async () => {
    await initialExamination.get_initial_examinations()
}
onMounted(fetchData)
