        ...
        <form class="flex flex-col w-full" @submit.prevent="submitForm">
            <div class="flex flex-row items-center mb-8">
                <div class="flex flex-col w-4/5">
                    <label for="tremor_severity" class="block mb-2 text-sm font-medium ">tremor_severity</label>
                ...
                <div class="flex flex-col w-4/5">
                    <label for="gait_speed" class="block mb-2 text-sm font-medium ">gait_speed</label>
                    <div class="flex flex-row items-center mr-12">
                        <input
                            type="number"
                ...
                <div class="flex flex-col w-4/5">
                    <label for="daily_assessment" class="block mb-2 text-sm font-medium ">daily_assessment</label>
                    <div class="flex flex-row items-center mr-12">
                        <input
                            type="number"
...
export default {
    ...
    methods: {
        submitForm() {
            axios.post('/api/sensor/parkinson/', this.formData)
                .then(response => {
